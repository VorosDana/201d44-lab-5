...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var added = sum( sum(a, b)[0], c)[0];[0] //I originally used sum for the var name, BAD IDEA
    var product = multiply(multiply(a, b)[0], c)[0];
    var messageSum = a + ' and ' + b + ' and ' + c + ' sum to ' + added + '.';
    var messageProduct = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product + '.';
    return[added, product, messageSum, messageProduct];
}
...
function sumArray(sumArr) { //eslint-disable-line
    var added = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0];
    var message = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + added + ' is their sum.';
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    // Product needs to start initialized, and the identity property of multiplication means that the first thing we
    // multiply into it is essentially assigned to product, because it is the same number
